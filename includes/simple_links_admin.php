		...
		function help(){
			$shortcode_help = array(
				...
				'content' => '<h5>' . __( 'You Can add a Simple Links List  to content using the shortcode', 'simple-links' ) . '[simple-links]</h5>
                        <p><em>' . __( 'Look for the puzzle button on the content editors for a form that generates the shortcode for you', 'simple-links' ) . '</em><br></p>
                                                ...
                                                orderby    = ' . __( '"title or random" - defaults to link order', 'simple-links' ) . '<br>
                                                ...
                                                remove_line_break = "true or false" - ' . __( 'Remove Line Break Between Images and Links', 'simple-links' ) . ' - default to false<br>
                                                ...
                                                id          = ' . __( '"An optional id for the outputed list', 'simple-links' ) . '"
                                                <br>
			...
			$widget_help = array(
				...
				'content' => '<h5>' . __( 'You May Add as Many Simple Links Widgets as You Would Like to Your Widget Areas', 'simple-links' ) . '</h5>
                                ...
                                Categories       = "' . __( 'Select with link categories to pull from', 'simple-links' ) . '"<br>
                                include_child_categories = "' . __( "If checked, links from your selected categories' child categories will display as well as links from your selected categories", 'simple-links', 'simple-links' ) . '"<br>
                                Order Links By   = "' . __( 'The Order in Which the Links will Display" - defaults to link order', 'simple-links' ) . '<br>
                                Order            = "' . __( 'The Order in which the links will Display', 'simple-links' ) . '"<br>
                                Show Description = "' . __( 'Display the Link\'s Description', 'simple-links' ) . '<br>
                                Show Description Formatting = "' . __( 'Display paragraphs to match the editor content', 'simple-links' ) . '"<br>
                                Number of LInks  = "' . __( 'Number of links to show', 'simple-links' ) . '"<br>
                                Show Image       = "' . __( 'Check the box to display the Link\'s Image', 'simple-links' ) . '<br>
                                Display Image Without Title       = "' . __( 'Check this box display the Link\'s Image without the Link\'s title under it. If Show Image is not checked, this will do nothing"', 'simple-links' ) . '<br>
                                Image Size       = "' . __( 'The Size of Image to Show if the previous box is checked', 'simple-links' ) . '<br>
                                Include Additional Fields     = "' . __( 'Display values from the Link\'s Additional Fields', 'simple-links' ) . '"<br>
                                Field Separator  = "' . __( 'And characters to display between fields and description" - defaults to ', 'simple-links' ) . '"-"<br>'
			);
			...
			switch ( $screen->id ){
				...
				case 'simple_link_page_simple-link-settings':
					...
					$screen->add_help_tab( array(
						...
						'content' => '<p>' . __( 'If they haven\'t already, Wordpress will be deprecating the built in links functionality', 'simple-links' ) . '.<br>
                                        ' . __( 'These settings take care of cleaning up the Built In Links right now', 'simple-links' ) . '<br>
                                        ' . __( 'By Checking "Remove Wordpress Built in Links", the Links menu will disappear along with the add new Admin Bar link', 'simple-links' ) . '. <br>
					...
					$screen->add_help_tab( array(
						...
						'content' => '<p>' . __( 'You have the ability to add an unlimited number of additional fields to the links by click the "Add Another" button', 'simple-links' ) . '. <br>
                                            ...
                                            ' . __( 'These fields will also be avaible by using the shortcode. For instance, if you wanted to display a field titled "author" and a field titled "notes" you shortcode would look something like this', 'simple-links' ) . '
					...
					$screen->add_help_tab( array(
						...
						'content' => '<p><strong>' . __( 'This is where you decided how much access editors will have', 'simple-links' ) . '</strong><br>
					...
					$screen->set_help_sidebar(
						__( '<p>' . __( 'These Sections will give your a brief description of what each group of settings does. Feel free to start a thread on the support forums if you would like additional help items covered in this section', 'simple-links' ) . '.</p>' ) );
